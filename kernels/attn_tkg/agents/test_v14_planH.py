"""
v14_planH correctness test: compare v14_planH vs v12e.
rtol=1e-3, atol=1e-3.
"""
import os
...
from v14_planH import qwen3_attn_tkg_fused_oproj_v14h
...
new_out, new_k, new_v = qwen3_attn_tkg_fused_oproj_v14h[2](*inputs)
xm.mark_step()
...
print("v14_planH vs v12e correctness:")
try:
