"""Benchmark v9_optimized: tp_broadcast + B saved scores."""
import os
import sys
...
os.environ["NEURON_RT_INSPECT_OUTPUT_DIR"] = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "_bench_out_v9_optimized"
)
...
from v9_optimized import qwen3_attn_tkg_fused_oproj
