"""
CPU-simulator correctness test for v14b_kv_norm.
...
Run:
    NKI_PRECISE_FP=1 NEURON_PLATFORM_TARGET_OVERRIDE=trn3 \\
        python test_v14b_kv_norm_sim.py
"""
...
from v14b_kv_norm import qwen3_attn_tkg_fused_oproj_v13bc_kv_norm
...
def run_one(pos_val, weights, hidden_rng_seed):
    ...
    result_np, K_out_np, V_out_np = nki.simulate(v14b_kv_norm_wrapper)(
