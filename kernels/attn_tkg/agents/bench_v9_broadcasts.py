"""Benchmark v9_broadcasts: broadcast GQA + cached scores."""
import os
import sys
...
os.environ["NEURON_RT_INSPECT_OUTPUT_DIR"] = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "_bench_out_v9_broadcasts"
)
...
from v9_broadcasts import qwen3_attn_tkg_fused_oproj
