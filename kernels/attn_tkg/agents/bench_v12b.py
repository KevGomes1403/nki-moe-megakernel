...
os.environ["NEURON_RT_INSPECT_OUTPUT_DIR"] = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "_bench_out_v12b"
)
...
qwen3_attn_tkg_fused_oproj_v12b = wrap_benchmark(qwen3_attn_tkg_fused_oproj_v12b, warmup=5, iters=50)

inputs = make_inputs()
qwen3_attn_tkg_fused_oproj_v12b(*inputs)

r = qwen3_attn_tkg_fused_oproj_v12b.last_result
if r:
    ...
    print("Benchmark result not available (r is None)")
