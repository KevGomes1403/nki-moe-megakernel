"""
Correctness test for v15a_peer_split_kv.

Same setup as test_v14b_kv_norm_pretransposed_sim.py, just swaps the import.
...
def run_one(pos_val, weights, hidden_rng_seed):
    ...
    result_np, K_out_np, V_out_np = nki.simulate(v15a_wrapper)(
