"""
Benchmark for v14_planD (LNC=2 Wo sharding, Plan D).
Output dir: _bench_out_v14d
"""
import os
import sys
...
print("=" * 60)
print("BENCHMARKING v14_planD[2] (LNC=2 Wo Sharding)")
print("=" * 60)

v14d_wrapped = wrap_benchmark(qwen3_attn_tkg_fused_oproj_v14d[2], warmup=5, iters=50)
v14d_wrapped(*inputs)
xm.mark_step()

r = v14d_wrapped.last_result
if r:
    print(f"\nv14_planD (LNC=2 Plan D):")
    ...
    print("v14_planD benchmark result not available (NTFF not captured)")
