"""Benchmark v10b: DMA pipeline v10b."""
import os
import sys
...
os.environ["NEURON_RT_INSPECT_OUTPUT_DIR"] = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "_bench_out_v10b"
)
...
from v10b import qwen3_attn_tkg_fused_oproj_v10b
...
kernel = wrap_benchmark(qwen3_attn_tkg_fused_oproj_v10b, warmup=5, iters=50)
