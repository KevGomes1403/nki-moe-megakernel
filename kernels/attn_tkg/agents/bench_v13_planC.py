...
os.environ["NEURON_RT_INSPECT_OUTPUT_DIR"] = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "_bench_out_v13c"
)
...
from v13_planC import qwen3_attn_tkg_fused_oproj_v13c
...
kernel = wrap_benchmark(qwen3_attn_tkg_fused_oproj_v13c, warmup=5, iters=50)
