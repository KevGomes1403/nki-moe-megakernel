"""Benchmark v11b: deferred Wo DMA pipeline v11b."""
import os
import sys
...
Wo = torch.tensor(rng.random((Hq_out, H)).astype(np.float16), dtype=torch.bfloat16).to(device)  # [1024, 2048]
...
kernel = wrap_benchmark(qwen3_attn_tkg_fused_oproj_v11b, warmup=5, iters=50)
