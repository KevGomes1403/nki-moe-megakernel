"""Benchmark v4: merged layout dedup. No o_proj; Hkv_tp=4."""
import os
import sys
...
os.environ["NEURON_RT_INSPECT_OUTPUT_DIR"] = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "_bench_out_v4"
)
...
from v4_merged_layout_dedup import qwen3_attn_tkg_fused
