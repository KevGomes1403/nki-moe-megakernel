...
os.environ["NEURON_RT_INSPECT_OUTPUT_DIR"] = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "_bench_out_v15c"
)
...
@nki.jit
def v15c_wrapper(hidden_states, Wq, Wk, Wv, Wo, q_norm_weight, k_norm_weight,
...
v15c_wrapper = wrap_benchmark(v15c_wrapper[2], warmup=5, iters=50)
...
v15c_wrapper(hidden,Wq,Wk,Wv,Wo,qnw,knw,gpan,K_cache,V_cache,cos,sin,pos,output)
xm.mark_step()

r_res = v15c_wrapper.last_result
if r_res:
