"""Benchmark v7_combined: fused o_proj with corrected DMA transpose."""
import os
import sys
...
from v7_combined import qwen3_attn_tkg_fused_oproj
...
# v7 uses [H, Hq_tp*d] = [2048, 1024] (not transposed)
