"""
v14_planG correctness test: compare v14_planG vs v12e.
rtol=1e-3, atol=1e-3.
"""
import os
...
from v14_planG import qwen3_attn_tkg_fused_oproj_v14g
...
new_out, new_k, new_v = qwen3_attn_tkg_fused_oproj_v14g[2](*inputs)
xm.mark_step()
...
print("v14_planG vs v12e correctness:")
try:
