"""Benchmark v10e: position threshold masking v10e."""
import os
import sys
...
os.environ["NEURON_RT_INSPECT_OUTPUT_DIR"] = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "_bench_out_v10e"
)
...
kernel = wrap_benchmark(qwen3_attn_tkg_fused_oproj_v10e, warmup=5, iters=50)
