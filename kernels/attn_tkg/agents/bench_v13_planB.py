...
os.environ["NEURON_RT_INSPECT_OUTPUT_DIR"] = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "_bench_out_v13b"
)
...
from v13_planB import qwen3_attn_tkg_fused_oproj_v13b
...
kernel = wrap_benchmark(qwen3_attn_tkg_fused_oproj_v13b, warmup=5, iters=50)
