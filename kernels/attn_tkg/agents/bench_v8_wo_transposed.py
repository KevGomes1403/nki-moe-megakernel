"""Benchmark v8_wo_transposed: contiguous DMA for Wo via caller-side transpose."""
import os
import sys
...
os.environ["NEURON_RT_INSPECT_OUTPUT_DIR"] = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "_bench_out_v8"
)
...
from v8_wo_transposed import qwen3_attn_tkg_fused_oproj
...
# v8+ uses Wo transposed: [Hq_tp*d, H] = [1024, 2048]
