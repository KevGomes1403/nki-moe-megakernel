"""Benchmark v3: reduce-replace. No o_proj; Hkv_tp=4."""
import os
import sys
...
os.environ["NEURON_RT_INSPECT_OUTPUT_DIR"] = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "_bench_out_v3"
)
...
from v3_reduce_replace import qwen3_attn_tkg_fused
