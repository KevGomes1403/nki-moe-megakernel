"""Benchmark v0: baseline (no o_proj, Hkv_tp=4). No o_proj; Hkv_tp=4."""
import os
import sys
...
os.environ["NEURON_RT_INSPECT_OUTPUT_DIR"] = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "_bench_out_v0"
)
...
from v0_attn_tkg_fused import qwen3_attn_tkg_fused
