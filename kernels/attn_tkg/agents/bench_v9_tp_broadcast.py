"""Benchmark v9_tp_broadcast: tp_broadcast all GQA loops."""
import os
import sys
...
os.environ["NEURON_RT_INSPECT_OUTPUT_DIR"] = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "_bench_out_v9_tp_broadcast"
)
...
from v9_tp_broadcast import qwen3_attn_tkg_fused_oproj
