"""
v9_broadcasts: Apply tp_broadcast pattern to all GQA=8 broadcast loops and fuse RMSNorm/softmax activations.
...
if __name__ == "__main__":
    ...
    def run_test(B=1, S_prior=640, H=2048, d=128, Hq_tp=8, Hkv_tp=1):
        ...
        print("\n[3/4] Running NKI kernel (v9_broadcasts)...")
