"""Correctness check: kernel_v20a vs kernel_v19b reference."""
import os, sys
...
kernel_v19b = load_kernel("/home/ubuntu/nki-moe/kernels/moe_fused_tkg/kernel_v19b.py", "_k19b")
...
ref_out = kernel_v19b[2](*args)
xm.mark_step()
ref_cpu = ref_out.cpu()

print("Running v20a candidate...")
cand_out = kernel_v20a[2](*args)
xm.mark_step()
