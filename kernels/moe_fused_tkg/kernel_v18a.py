...
kernel_v18a — Plan C: tensor_partition_reduce for RMSNorm cross-partition sum
=============================================================
...
def qwen3_moe_fused_tkg(
    ...
    for t in nl.static_range(T):
        ...
        for k in nl.affine_range(K):
            ...
            # ----------------------------------------------------------------
            # Plan C: issue down DMAs immediately after gate_up DMA.
            ...
            # engine pipelines gate_up + down0 + down1 together, allowing the down
            # DMAs to complete during tile-1 tensor_copy prep + gate/up matmul.
            # ----------------------------------------------------------------
