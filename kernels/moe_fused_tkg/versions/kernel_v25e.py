...
kernel_v25e — Plan E: Combined micro-optimizations
=============================================================
Based on v19b (Plan F: K=8 full prefetch).
...
def run(inp, gamma, router_w, gate_up_w, down_w):
    """Run kernel_v25e with native weight layouts — no preprocessing required.
