...
kernel_v21a — Plan A: Cross-Expert Down PSUM Accumulation (+ Plan F prefetch)
=============================================================
Based on kernel_v19b (Plan F: K=8 full prefetch).
...
def run(inp, gamma, router_w, gate_up_w, down_w):
    """Run kernel_v21a with native weight layouts — no preprocessing required.
