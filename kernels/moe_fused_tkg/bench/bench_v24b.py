"""Benchmark for kernel_v24b — Plan B: DMA tile-1 in prefetch phase."""
import os, sys
os.environ["NEURON_PLATFORM_TARGET_OVERRIDE"] = "trn2"
os.environ["NEURON_RT_INSPECT_ENABLE"] = "1"
os.environ["NEURON_RT_INSPECT_DEVICE_PROFILE"] = "1"
os.environ["NEURON_RT_INSPECT_OUTPUT_DIR"] = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "output_v24b"
)
...
spec = importlib.util.spec_from_file_location(
    "_kernel", "/home/ubuntu/nki-moe/kernels/moe_fused_tkg/kernel_v24b.py"
)
...
if r:
    print(f"\n{'='*60}")
    print("  kernel_v24b — Plan B: DMA tile-1 in prefetch phase")
    print(f"{'='*60}")
    ...
    print(f"\n  Baseline v22b: device_time_us≈114, tensor=47.1%, dma=63.9%, sw_dma_packets=8320")
else:
