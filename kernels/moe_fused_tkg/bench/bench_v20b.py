"""Benchmark for kernel_v20b — Plan B: 2D coalesced gate_up + full-H down DMA."""
import os, sys
os.environ["NEURON_PLATFORM_TARGET_OVERRIDE"] = "trn2"
os.environ["NEURON_RT_INSPECT_ENABLE"] = "1"
os.environ["NEURON_RT_INSPECT_DEVICE_PROFILE"] = "1"
os.environ["NEURON_RT_INSPECT_OUTPUT_DIR"] = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "output_v20b"
)
...
spec = importlib.util.spec_from_file_location(
    "_kernel", "/home/ubuntu/nki-moe/kernels/moe_fused_tkg/kernel_v20b.py"
)
...
if r:
    print(f"\n{'='*60}")
    print("  kernel_v20b — Plan B: 2D coalesced gate_up + full-H down")
    print(f"{'='*60}")
    ...
    print(f"  Plan A:  device_time_us=115.97 (no improvement)")
else:
