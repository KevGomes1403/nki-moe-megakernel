"""Benchmark for kernel_v23a — Plan A: Cross-expert down PSUM accumulation."""
import os, sys
os.environ["NEURON_PLATFORM_TARGET_OVERRIDE"] = "trn2"
os.environ["NEURON_RT_INSPECT_ENABLE"] = "1"
os.environ["NEURON_RT_INSPECT_DEVICE_PROFILE"] = "1"
os.environ["NEURON_RT_INSPECT_OUTPUT_DIR"] = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "output_v23a"
)
...
spec = importlib.util.spec_from_file_location(
    "_kernel", "/home/ubuntu/nki-moe/kernels/moe_fused_tkg/kernel_v23a.py"
)
...
if r:
    print(f"\n{'='*60}")
    print("  kernel_v23a — Plan A: Cross-expert down PSUM accumulation")
    print(f"{'='*60}")
    ...
    print(f"\n  Baseline: v22b device_time_us=115.14, sw_dma_packet_count=8320")
else:
