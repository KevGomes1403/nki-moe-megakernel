"""Benchmark for kernel_v29k — Plan K: single-wave 8-expert processing."""
import os, sys
os.environ["NEURON_PLATFORM_TARGET_OVERRIDE"] = "trn2"
os.environ["NEURON_RT_INSPECT_ENABLE"] = "1"
os.environ["NEURON_RT_INSPECT_DEVICE_PROFILE"] = "1"
os.environ["NEURON_RT_INSPECT_OUTPUT_DIR"] = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "output_v29k"
)
...
spec = importlib.util.spec_from_file_location(
    "_kernel", "/home/ubuntu/nki-moe/kernels/moe_fused_tkg/kernel_v29k.py"
)
...
if r:
    print(f"\n{'='*60}")
    print("  kernel_v29k — Plan K: single-wave 8-expert processing")
    print(f"{'='*60}")
