"""Benchmark for kernel_v24a — Round 3 Plan A: Contiguous router DMA."""
import os, sys
os.environ["NEURON_PLATFORM_TARGET_OVERRIDE"] = "trn2"
os.environ["NEURON_RT_INSPECT_ENABLE"] = "1"
os.environ["NEURON_RT_INSPECT_DEVICE_PROFILE"] = "1"
os.environ["NEURON_RT_INSPECT_OUTPUT_DIR"] = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "output_v24a"
)
...
spec = importlib.util.spec_from_file_location(
    "_kernel", "/home/ubuntu/nki-moe/kernels/moe_fused_tkg/kernel_v24a.py"
)
...
if r:
    print(f"\n{'='*60}")
    print("  kernel_v24a — Round 3 Plan A: Contiguous router DMA")
    print(f"{'='*60}")
    ...
    print(f"\n  Baseline v22b: device_time_us≈114, sw_dma_packet_count=8320")
    print(f"  Change: router DMA 3D non-contiguous (512 pkts) → per-tile contiguous 2D (16 pkts)")
else:
