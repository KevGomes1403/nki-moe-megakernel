"""Benchmark for kernel_v25c — Plan C: Eliminate tile-1 copies via K=64 matmul."""
import os, sys
os.environ["NEURON_PLATFORM_TARGET_OVERRIDE"] = "trn2"
os.environ["NEURON_RT_INSPECT_ENABLE"] = "1"
os.environ["NEURON_RT_INSPECT_DEVICE_PROFILE"] = "1"
os.environ["NEURON_RT_INSPECT_OUTPUT_DIR"] = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "output_v25c"
)
...
spec = importlib.util.spec_from_file_location(
    "_kernel", "/home/ubuntu/nki-moe/kernels/moe_fused_tkg/kernel_v25c.py"
)
...
if r:
    print(f"\n{'='*60}")
    print("  kernel_v25c — Plan C: K=64 matmul (no tile-1 copy)")
    print(f"{'='*60}")
    ...
    print(f"  Plan B (v20b): device_time_us=115.97")
else:
