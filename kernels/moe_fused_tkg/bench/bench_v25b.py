"""Benchmark for kernel_v25b — Plan B: 3D batched gate_up DMA + full-H down DMA."""
import os, sys
os.environ["NEURON_PLATFORM_TARGET_OVERRIDE"] = "trn2"
os.environ["NEURON_RT_INSPECT_ENABLE"] = "1"
os.environ["NEURON_RT_INSPECT_DEVICE_PROFILE"] = "1"
os.environ["NEURON_RT_INSPECT_OUTPUT_DIR"] = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "output_v25b"
)
...
spec = importlib.util.spec_from_file_location(
    "_kernel", "/home/ubuntu/nki-moe/kernels/moe_fused_tkg/kernel_v25b.py"
)
...
if r:
    print(f"\n{'='*60}")
    print("  kernel_v25b — Plan B: 3D batched gate_up DMA + full-H down")
    print(f"{'='*60}")
    ...
    print(f"\n  Baseline: v19b device_time_us=115.04, sw_dma_packet_count=8320")
    print(f"  v20b:    device_time_us=~115, sw_dma_packet_count=~128+16=144")
else:
