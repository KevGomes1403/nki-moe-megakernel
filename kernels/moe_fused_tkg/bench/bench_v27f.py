"""Benchmark for kernel_v27f — v27d + single-expert PSUM."""
import os, sys
os.environ["NEURON_PLATFORM_TARGET_OVERRIDE"] = "trn2"
os.environ["NEURON_RT_INSPECT_ENABLE"] = "1"
os.environ["NEURON_RT_INSPECT_DEVICE_PROFILE"] = "1"
os.environ["NEURON_RT_INSPECT_OUTPUT_DIR"] = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "output_v27f"
)
...
spec = importlib.util.spec_from_file_location(
    "_kernel", "/home/ubuntu/nki-moe/kernels/moe_fused_tkg/kernel_v27f.py"
)
...
if r:
    print(f"\n{'='*60}")
    print("  kernel_v27f — v27d + single-expert PSUM (12 cols)")
    print(f"{'='*60}")
    ...
    print(f"\n  Baseline v27d: device_time_us=103.48")
    print(f"  Baseline v26g: device_time_us=104.89")
    print(f"  Target: <=100 us")
else:
