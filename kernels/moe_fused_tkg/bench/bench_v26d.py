"""Benchmark for kernel_v26d."""
import os, sys
os.environ["NEURON_PLATFORM_TARGET_OVERRIDE"] = "trn2"
os.environ["NEURON_RT_INSPECT_ENABLE"] = "1"
os.environ["NEURON_RT_INSPECT_DEVICE_PROFILE"] = "1"
os.environ["NEURON_RT_INSPECT_OUTPUT_DIR"] = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "output_v26d"
)
...
spec = importlib.util.spec_from_file_location(
    "_kernel", "/home/ubuntu/nki-moe/kernels/moe_fused_tkg/kernel_v26d.py"
)
...
if r:
    print(f"\n{'='*60}")
    print("  kernel_v26d — Plan D: Direct PSUM read + fused affinity")
    print(f"{'='*60}")
    ...
    print(f"\n  Baseline v25e: device_time_us=107.94, active_time=96.12")
