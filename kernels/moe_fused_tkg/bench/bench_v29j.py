"""Benchmark for kernel_v29j — v28f with shared_hbm output + remove dead aff_bcast memset."""
import os, sys
os.environ["NEURON_PLATFORM_TARGET_OVERRIDE"] = "trn2"
os.environ["NEURON_RT_INSPECT_ENABLE"] = "1"
os.environ["NEURON_RT_INSPECT_DEVICE_PROFILE"] = "1"
os.environ["NEURON_RT_INSPECT_OUTPUT_DIR"] = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "_bench_out_v29j"
)
...
spec = importlib.util.spec_from_file_location(
    "_kernel", "/home/ubuntu/nki-moe/kernels/moe_fused_tkg/kernel_v29j.py"
)
...
if r:
    print(f"\n{'='*60}")
    print("  kernel_v29j — v28f + shared_hbm output + remove dead aff_bcast memset")
    print(f"{'='*60}")
