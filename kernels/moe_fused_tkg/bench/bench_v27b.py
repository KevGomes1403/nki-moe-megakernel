"""Benchmark for kernel_v27b — double-buffered 1-expert-at-a-time."""
import os, sys
os.environ["NEURON_PLATFORM_TARGET_OVERRIDE"] = "trn2"
os.environ["NEURON_RT_INSPECT_ENABLE"] = "1"
os.environ["NEURON_RT_INSPECT_DEVICE_PROFILE"] = "1"
os.environ["NEURON_RT_INSPECT_OUTPUT_DIR"] = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "output_v27b"
)
...
spec = importlib.util.spec_from_file_location(
    "_kernel", "/home/ubuntu/nki-moe/kernels/moe_fused_tkg/kernel_v27b.py"
)
...
if r:
    print(f"\n{'='*60}")
    print("  kernel_v27b — Plan B: double-buffered 1-expert-at-a-time")
    print(f"{'='*60}")
    ...
    print(f"\n  Baseline v26g: device_time_us=104.89")
