...
os.environ["NEURON_RT_INSPECT_OUTPUT_DIR"] = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "output_v28i"
)
...
spec = importlib.util.spec_from_file_location(
    "_kernel", "/home/ubuntu/nki-moe/kernels/moe_fused_tkg/kernel_v28i.py"
)
...
if r:
    ...
    print(f"  v27d=103.48, v28f=98.15, v28i={r.device_time_us:.2f}, target=95.00")
