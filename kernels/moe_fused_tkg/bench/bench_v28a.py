"""Benchmark for kernel_v28a — Plan A: direct K=64 matmul for I1-tile."""
import os, sys
os.environ["NEURON_PLATFORM_TARGET_OVERRIDE"] = "trn2"
os.environ["NEURON_RT_INSPECT_ENABLE"] = "1"
os.environ["NEURON_RT_INSPECT_DEVICE_PROFILE"] = "1"
os.environ["NEURON_RT_INSPECT_OUTPUT_DIR"] = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "output_v28a"
)
...
spec = importlib.util.spec_from_file_location(
    "_kernel", "/home/ubuntu/nki-moe/kernels/moe_fused_tkg/kernel_v28a.py"
)
...
if r:
    print(f"\n{'='*60}")
    print("  kernel_v28a — Plan A: K=64 direct matmul, no gate_t1/up_t1")
    print(f"{'='*60}")
    ...
    print(f"  Baseline v27d: 103.48 us  |  Target: <=95 us")
else:
