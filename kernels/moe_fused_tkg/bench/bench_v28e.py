"""Benchmark for kernel_v28e — v27d with router DMA hw_dge (dge_mode=3) + _ROUTER_BATCH=8."""
import os, sys
os.environ["NEURON_PLATFORM_TARGET_OVERRIDE"] = "trn2"
os.environ["NEURON_RT_INSPECT_ENABLE"] = "1"
os.environ["NEURON_RT_INSPECT_DEVICE_PROFILE"] = "1"
os.environ["NEURON_RT_INSPECT_OUTPUT_DIR"] = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "output_v28e"
)
...
spec = importlib.util.spec_from_file_location(
    "_kernel", "/home/ubuntu/nki-moe/kernels/moe_fused_tkg/kernel_v28e.py"
)
...
if r:
    print(f"\n{'='*60}")
    print("  kernel_v28e — Plan E: router DMA dge_mode=3 + _ROUTER_BATCH=8")
    print(f"{'='*60}")
    ...
    print(f"\n  Baseline v27d: device_time_us=103.48, sw_dma_packet_count=8320")
