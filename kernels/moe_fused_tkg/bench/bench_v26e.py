"""Benchmark for kernel_v26e — Full-H coalesced down DMA."""
import os, sys
os.environ["NEURON_PLATFORM_TARGET_OVERRIDE"] = "trn2"
os.environ["NEURON_RT_INSPECT_ENABLE"] = "1"
os.environ["NEURON_RT_INSPECT_DEVICE_PROFILE"] = "1"
os.environ["NEURON_RT_INSPECT_OUTPUT_DIR"] = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "output_v26e"
)
...
spec = importlib.util.spec_from_file_location(
    "_kernel", "/home/ubuntu/nki-moe/kernels/moe_fused_tkg/kernel_v26e.py"
)
...
if r:
    print(f"\n{'='*60}")
    print("  kernel_v26e — Plan E: Full-H coalesced down DMA")
    print(f"{'='*60}")
    ...
    print(f"\n  Baseline v25e: device_time_us=107.94, hbm_read=31760 KiB, sw_dma_packet_count=8320")
