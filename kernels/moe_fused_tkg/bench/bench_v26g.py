"""Benchmark for kernel_v26g — 2-wave expert processing."""
import os, sys
os.environ["NEURON_PLATFORM_TARGET_OVERRIDE"] = "trn2"
os.environ["NEURON_RT_INSPECT_ENABLE"] = "1"
os.environ["NEURON_RT_INSPECT_DEVICE_PROFILE"] = "1"
os.environ["NEURON_RT_INSPECT_OUTPUT_DIR"] = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "output_v26g"
)
...
spec = importlib.util.spec_from_file_location(
    "_kernel", "/home/ubuntu/nki-moe/kernels/moe_fused_tkg/kernel_v26g.py"
)
...
if r:
    print(f"\n{'='*60}")
    print("  kernel_v26g — Plan G: 2-wave experts (4 buffer sets)")
    print(f"{'='*60}")
    ...
    print(f"\n  Baseline v25e: device_time_us=107.94")
