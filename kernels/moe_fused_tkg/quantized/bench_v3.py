...
os.environ["NEURON_RT_INSPECT_OUTPUT_DIR"] = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "output_v3"
)
...
spec = importlib.util.spec_from_file_location(
    "_kernel_v3", "/home/ubuntu/nki-moe/kernels/moe_fused_tkg/quantized/v3.py"
)
...
# New per-column scales: [E, GU=384]
...
# New per-column scales: [E, H_shard=512]
