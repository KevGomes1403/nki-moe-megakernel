"""
Benchmark for v14a (trn3 port of v12i — W8A16 BF16 activations).
"""
import os
import sys
...
os.environ["NEURON_RT_INSPECT_OUTPUT_DIR"] = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "_bench_out_v14a"
)
...
print("Running benchmark for v14a (trn3 port of v12i)...")
kernel(*args)
