...
v5 — Plan D: Collapse gate_up FP8→BF16 Cast to ONE Call per Expert
===================================================================
Based on v4 (Plan C: Batch FP8→BF16 Casts per h1 row).

Key changes vs v4:
  V5.1: Collapse gate_up dequant from H_free=16 calls of [128P,384F]
        to ONE call of the full [128P, H_free=16, GU_FLAT=384] tensor per expert.
        Total dequant calls per expert: 3 (1 gate_up + 2 down) vs 18 in v4.
        Total dequant per wave: 4 experts × 3 = 12 calls (vs 72 in v4, 208 in v3).
  V5.2: Everything else identical to v4.
