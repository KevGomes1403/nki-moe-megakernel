...
kernel_v27f — v27d + single-expert PSUM (12 cols, per-expert memset)
=====================================================================
Based on v27d (v26g with redundant memsets removed).

Changes vs v27d:
  Replace 4-expert PSUM (48 cols) with single-expert PSUM (12 cols).
  Per-expert PSUM memset instead of per-wave. Smaller PSUM allocation
  may improve compiler scheduling quality.
...
def qwen3_moe_fused_tkg(
    ...
    for t in nl.static_range(T):
        ...
        # NOTE: No wave-level PSUM memset — per-expert memset below.
