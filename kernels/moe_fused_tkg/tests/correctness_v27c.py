"""Correctness check: kernel_v27c vs kernel_v19b."""
import os, sys
...
kernel_cand = load_kernel("/home/ubuntu/nki-moe/kernels/moe_fused_tkg/kernel_v27c.py", "_k27c")
