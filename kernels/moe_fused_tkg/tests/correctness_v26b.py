"""Correctness check: kernel_v26b vs kernel_v19b."""
import os, sys
...
kernel_cand = load_kernel("/home/ubuntu/nki-moe/kernels/moe_fused_tkg/kernel_v26b.py", "_k26b")
