"""Correctness check: kernel_v26f vs kernel_v19b."""
import os, sys
...
kernel_cand = load_kernel("/home/ubuntu/nki-moe/kernels/moe_fused_tkg/kernel_v26f.py", "_k26f")
