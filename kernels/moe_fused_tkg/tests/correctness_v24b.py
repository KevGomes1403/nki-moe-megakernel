"""Correctness check: kernel_v24b vs kernel_v20a reference."""
import os, sys
...
kernel_v24b = load_kernel("/home/ubuntu/nki-moe/kernels/moe_fused_tkg/kernel_v24b.py", "_k24b")
...
print("Running v24b candidate...")
cand_out = kernel_v24b[2](*args)
xm.mark_step()
