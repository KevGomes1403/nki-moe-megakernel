"""Correctness check: kernel_v22b vs kernel_v20a reference."""
import os, sys
...
kernel_v22b = load_kernel("/home/ubuntu/nki-moe/kernels/moe_fused_tkg/kernel_v22b.py", "_k22b")
...
print("Running v22b candidate...")
cand_out = kernel_v22b[2](*args)
xm.mark_step()
