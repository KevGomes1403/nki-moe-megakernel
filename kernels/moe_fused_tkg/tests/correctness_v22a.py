"""Correctness check: kernel_v22a vs kernel_v20a reference."""
import os, sys
...
kernel_v22a = load_kernel("/home/ubuntu/nki-moe/kernels/moe_fused_tkg/kernel_v22a.py", "_k22a")
...
print("Running v22a candidate...")
cand_out = kernel_v22a[2](*args)
xm.mark_step()
