"""Correctness check: kernel_v24a vs kernel_v20a reference."""
import os, sys
...
kernel_v24a = load_kernel("/home/ubuntu/nki-moe/kernels/moe_fused_tkg/kernel_v24a.py", "_k24a")
...
print("Running v24a candidate...")
cand_out = kernel_v24a[2](*args)
xm.mark_step()
