"""Correctness check: kernel_v23b vs kernel_v20a reference."""
import os, sys
...
kernel_v23b = load_kernel("/home/ubuntu/nki-moe/kernels/moe_fused_tkg/kernel_v23b.py", "_k23b")
...
print("Running v23b candidate...")
cand_out = kernel_v23b[2](*args)
xm.mark_step()
