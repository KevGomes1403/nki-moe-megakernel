"""Correctness check: kernel_v18b vs kernel_v16c reference."""
...
# Load v18b (candidate)
spec18b = importlib.util.spec_from_file_location(
    "_kernel18b", "/home/ubuntu/nki-moe/kernels/moe_fused_tkg/kernel_v18b.py"
)
mod18b = importlib.util.module_from_spec(spec18b)
spec18b.loader.exec_module(mod18b)
kernel_v18b = mod18b.qwen3_moe_fused_tkg
...
# Run candidate
print("Running v18b candidate...")
cand_out = kernel_v18b[2](*args)
xm.mark_step()
