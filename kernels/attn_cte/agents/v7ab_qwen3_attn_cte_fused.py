        ...
        for gi in nl.affine_range(gqa):
            ...
            for qsi in nl.affine_range(num_s_tiles):
                ...
                nisa.dma_copy(dst=neg_max_bc,
                              src=neg_max.ap(pattern=[[1, PMAX], [0, PMAX]], offset=0)) # Profiler: Idle Gaps
                ...
                nisa.dma_copy(dst=inv_bc,
                              src=inv1.ap(pattern=[[1, PMAX], [0, PMAX]], offset=0)) # Profiler: Idle Gaps
...
if __name__ == "__main__":
    ...
    def run_test(B, S, H=2048, d=128, Hq_tp=8, Hkv_tp=4):
        print(f"\n{'=' * 70}")
        print(f"qwen3_attn_cte_fused v7ab Test: B={B}, S={S}, H={H}, d={d}")
